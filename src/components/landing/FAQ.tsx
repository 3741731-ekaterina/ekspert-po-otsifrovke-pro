...
const groups = [
  ...
  },
  {
    ...
    faqs: [
      {
        num: 12,
        q: 'Как получить учебник по управленческому учёту?',
        a: 'Учебник бесплатно для всех, кто покупает курс до 1 мая. Отдельно сейчас нельзя.',
      },
      {
        num: 13,
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-10 space-y-2">
            ...
            <p className="text-slate-500 text-sm">13 вопросов, которые задают чаще всего — с честными ответами.</p>
          </div>
